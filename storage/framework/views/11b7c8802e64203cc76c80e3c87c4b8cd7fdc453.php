            ...
            >
              <div class="relative team-image">
                  <video class="w-full max-h-60	" controls  >
                    ...
                    <source src="/video/<?php echo e($gallery->video); ?>" type="video/ogg"> 
                  </video>
              </div>
              <div class="p-8">
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-company-profiles\resources\views/frontend/video.blade.php ENDPATH**/ ?>