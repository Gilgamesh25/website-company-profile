            ...
            <?php $__empty_1 = true; $__currentLoopData = $blog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              ...
              >
                <div class="mb-5 max-h-60 overflow-hidden blog-image rounded-xl">
                  <img class="w-full" src="/image/<?php echo e($blog->image); ?>" alt="blog" />
                </div>
                <div class="blog-content">
                  <ul class="flex mb-5 meta">
                    <li>Type: <a href="javascript:void(0)"><?php echo e($blog->author); ?></a></li>
                    <li class="ml-12"><?php echo e(date('d-m-Y', strtotime($blog->created_at))); ?></li>
                  </ul>
                  <p class="mb-6 text-2xl leading-snug text-gray-900">
                    <?php echo e($blog->title); ?>

                  </p>
                  <a class="text-theme-color-2" href="/blog/<?php echo e($blog->title); ?>">
                    Read More
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-company-profiles\resources\views/frontend/blog.blade.php ENDPATH**/ ?>