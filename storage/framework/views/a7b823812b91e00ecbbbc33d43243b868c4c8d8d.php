...
<!--====== BRAMD PART START ======-->
    ...
    <section id="team" class="team-area pt-120">
      <div class="container">
        ...
        <!-- row -->
        <div class="justify-center row">
       <?php $__empty_1 = true; $__currentLoopData = $gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
           <div class="w-full sm:w-2/3 lg:w-1/3">
            ...
            >
              <div class="relative team-image">
                <img class="w-full max-h-60	" src="/image/<?php echo e($gallery->image); ?>" alt="Team" />
              </div>
              <div class="p-8">
                <h5 class="mb-1 text-xl font-bold text-gray-900"><?php echo e($gallery->name); ?></h5>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-company-profiles\resources\views/frontend/gallery.blade.php ENDPATH**/ ?>