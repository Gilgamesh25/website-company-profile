...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-12 ">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form class="w-full max-w-sm" method="POST" action="<?php echo e(route('gallery.store')); ?>"  enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
 <script>
        ...
        </script><?php /**PATH C:\xampp\htdocs\web-company-profiles\resources\views/dashboard/gallery-add.blade.php ENDPATH**/ ?>